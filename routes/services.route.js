...
const { getServices,getServiceByID,addService, updateServices,deleteService,uploadServicePhoto,getServiceImage,getServiceImageById,downloadImage } = require('../controllers/service.controller.js');
